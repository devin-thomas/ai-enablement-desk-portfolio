...
function RequestDetailView({ request, analyses, clarificationAnswers, decisions, automations, artifacts, analysisBusy, audioBusy, onBack, onAnalyze, onAnswer, onDecision, onAutomationRetry, onAudio }: { request: RequestDetail; analyses: AnalysisRun[]; clarificationAnswers: ClarificationAnswerRecord[]; decisions: DecisionRecord[]; automations: AutomationAttempt[]; artifacts: ArtifactRecord[]; analysisBusy: boolean; audioBusy: boolean; onBack: () => void; onAnalyze: () => Promise<void>; onAnswer: (submission: ClarificationAnswerSubmission) => Promise<void>; onDecision: (submission: HumanDecision) => Promise<void>; onAutomationRetry: (attemptId: string) => Promise<void>; onAudio: () => Promise<void> }) {
